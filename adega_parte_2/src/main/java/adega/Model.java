...
{	
	...
	public void removeBebida(String codigoDeBarras)
	{
		...
		for(Bebida bebidaBanco: bebidaEncontrada) 
		{
			...
			{
				System.out.println("bebidaBanco; "+bebidaBanco.getCodigoDeBarras());
				System.out.println("codigo de comparacao; "+codigoDeBarras);
	...
	public List<Bebida> alterarBebidaCodigo(String codigoDeBarras,Bebida bebida)
	{
		List<Bebida> bebidasEncontradas= new LinkedList<Bebida>(); /*criando lista pra guardar bebidas encontradas no banco*/
